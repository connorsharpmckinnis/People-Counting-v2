...
def main():
    ...
    #people, path = basic_count("image.png", config={"model": "yolo11n.pt", "conf_threshold": 0.35})
    #print(people)
    #people, path = sliced_count("image.png", config={"model": "yolo11n.pt", "conf_threshold": 0.35})
    #print(people)
    people, path = video_count("video.mp4", config={"model": "yolo11n.pt", "conf_threshold": 0.35})
    #people, path = sliced_video_count(video_path="video.mp4", config={"model": "yolo11n.pt", "conf_threshold": 0.35})
